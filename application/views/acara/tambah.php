<div class="flex-1 p-6 overflow-auto">
    ...
    <div class="bg-white rounded-lg shadow p-6">
        <form action="<?= base_url('acara/simpan') ?>" method="post" enctype="multipart/form-data" id="acaraForm">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="hidden" id="waktu_value" name="waktu" required>
                    ...
                    <div class="relative">
                        <input type="text" id="waktu_display"
                            ...
                            readonly placeholder="00:00" required>
            ...
            <div class="mt-6 text-right">
                <button type="submit" id="submitBtn" class="bg-primary-600 hover:bg-primary-700 text-white px-6 py-2 rounded-lg">
...
<script>
    ...
    function updateDisplay() {
        ...
        } else if (selectedJam !== null) {
            waktuDisplay.value = `${pad(selectedJam)}:--`;
        } else if (selectedMenit !== null) {
            waktuDisplay.value = `--:${pad(selectedMenit)}`;
        }
    }
    
    // Set nilai awal (opsional)
    selectedJam = 13;
    selectedMenit = 0;
    updateDisplay();
    ...
    document.getElementById('acaraForm').addEventListener('submit', async function(e) {
        ...
        try {
            const response = await fetch('<?= base_url('acara/check_conflict') ?>', {
                ...
                body: `tanggal=${tanggal}&waktu=${waktu}&tempat=${tempat}`
            });
