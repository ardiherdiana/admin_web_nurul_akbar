<div class="flex-1 p-6 overflow-auto">
    <div class="flex justify-between items-center mb-6">
        <h1 class="text-2xl font-semibold text-gray-800">Edit Pengurus</h1>
        ...
        <form action="<?= base_url('pengurus/update/'.$pengurus->id_pengurus) ?>" method="post" enctype="multipart/form-data">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <input type="text" id="nama_pengurus" name="nama_pengurus" value="<?= $pengurus->nama_pengurus ?>" class="w-full rounded-md border-gray-300 shadow-sm focus:border-primary-500 focus:ring focus:ring-primary-500 focus:ring-opacity-50" required>
                </div>
                
                <div>
                    <label for="jabatan" class="block text-sm font-medium text-gray-700 mb-1">Jabatan <span class="text-red-500">*</span></label>
                    <input type="text" id="jabatan" name="jabatan" value="<?= $pengurus->jabatan ?>" class="w-full rounded-md border-gray-300 shadow-sm focus:border-primary-500 focus:ring focus:ring-primary-500 focus:ring-opacity-50" required>
                </div>
                
                <div class="col-span-2">
                    <label for="foto_pengurus" class="block text-sm font-medium text-gray-700 mb-1">Foto Pengurus</label>
                    <?php if(!empty($pengurus->foto_pengurus)): ?>
                        <div class="mb-2">
                            <img src="data:image/jpeg;base64,<?= base64_encode($pengurus->foto_pengurus) ?>" alt="<?= $pengurus->nama_pengurus ?>" class="h-32 w-32 object-cover rounded-full">
                ...
                <div class="col-span-2">
                    ...
                    <textarea id="jobdesk" name="jobdesk" rows="3" class="w-full rounded-md border-gray-300 shadow-sm focus:border-primary-500 focus:ring focus:ring-primary-500 focus:ring-opacity-50"><?= $pengurus->jobdesk ?></textarea>
                </div>
                
                <div class="col-span-2">
                    <label for="catatan" class="block text-sm font-medium text-gray-700 mb-1">Catatan</label>
                    <textarea id="catatan" name="catatan" rows="3" class="w-full rounded-md border-gray-300 shadow-sm focus:border-primary-500 focus:ring focus:ring-primary-500 focus:ring-opacity-50"><?= $pengurus->catatan ?></textarea>
                </div>
            </div>
